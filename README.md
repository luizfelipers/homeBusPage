# Prototype of HomePage for traveling agency, built with ReactJs.
...
### Feel free to clone this repo and modify it the way you want. Follow the instructions below to run it locally:
